...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if(ownerOf(_tokenId1) == msg.sender){
            ...
            sender = ownerOf(_tokenId1);
            receiverToken = _tokenId2;
            receiver = ownerOf(_tokenId2);
        }else if(ownerOf(_tokenId2) == msg.sender){
            senderToken = _tokenId2;
            sender = ownerOf(_tokenId2);
            receiverToken = _tokenId1;
            receiver = ownerOf(_tokenId1);
        }else{
            require(false, "neither _tokenId1 nor _tokenId2 is sender.");
        }
